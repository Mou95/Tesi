...
\begin{description}
    ...
    \item[{\hyperref[cap:progetto-stage]{Il secondo capitolo}}] approfondisce il progetto di stage nella sua interezza. Vengono infatti descritti gli strumenti utilizzati dallo stagista, i problemi affrontati, le scelte intraprese e infine viene illustrata una panoramica del prodotto ottenuto durante le 300 ore di lavoro.
    
    \item[{\hyperref[cap:analisi-requisiti]{Il terzo capitolo}}] approfondisce ...
    
    \item[{\hyperref[cap:progettazione-codifica]{Il quarto capitolo}}] contiene 
